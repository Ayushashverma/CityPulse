 ...
 */
@WebServlet("/DeleteTravelAgency")
public class DeleteTravelAgency extends HttpServlet {
	HttpSession hs=null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.isNew())
		{
			...
			String quer="delete from travelagency where sno=?";
			try
			{
		...
		{
			response.sendRedirect("jsp/viewTravelAgency.jsp");// TODO Auto-generated method stub
		}
		else
