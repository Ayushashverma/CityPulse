 ...
 */
@WebServlet("/UpdateTheaters")
public class UpdateTheaters extends HttpServlet {
	HttpSession hs=null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String strupdate="update theaters set name=?, location=?, website=? where sno=?";
		...
		try
		{
			...
			if(rw>0)
			{
				response.sendRedirect("jsp/viewTheaters.jsp");
			}
		}
