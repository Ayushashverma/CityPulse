 ...
 */
@WebServlet("/DeleteHospitals")
public class DeleteHospitals extends HttpServlet {
	HttpSession hs=null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.isNew())
		{
			...
			String quer="delete from hospitals where sno=?";
			try
			{
		...
		{
			response.sendRedirect("jsp/viewHospitals.jsp");// TODO Auto-generated method stub
		}
		else
