 ...
 */
@WebServlet("/UpdateHospitals")
public class UpdateHospitals extends HttpServlet {
	HttpSession hs=null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String strupdate="update hospitals set name=?, location=?, website=? where sno=?";
		...
		try
		{
			...
			if(rw>0)
			{
				response.sendRedirect("jsp/viewHospitals.jsp");
			}
		}
