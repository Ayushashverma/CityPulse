...
/**
 * Servlet implementation class DeleteAtm
 */
@WebServlet("/DeleteAtm")
public class DeleteAtm extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.isNew())
		{
			...
			String quer="delete from atm where sno=?";
			try
			{
		...
		{
			response.sendRedirect("jsp/viewAtm.jsp");// TODO Auto-generated method stub
		}
		else
