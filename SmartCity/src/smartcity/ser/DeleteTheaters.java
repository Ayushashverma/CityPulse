 ...
 */
@WebServlet("/DeleteTheaters")
public class DeleteTheaters extends HttpServlet {
	HttpSession hs=null;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.isNew())
		{
			...
			String quer="delete from theaters where sno=?";
			try
			{
		...
		{
			response.sendRedirect("jsp/viewTheaters.jsp");// TODO Auto-generated method stub
		}
		else
