...
/**
 * Servlet implementation class DeleteHotels
 */
...
public class DeleteHotels extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hs.isNew())
		{
			...
			String quer="delete from hotel where sno=?";
			try
			{
		...
		{
			response.sendRedirect("jsp/viewHotels.jsp");// TODO Auto-generated method stub
		}
		else
