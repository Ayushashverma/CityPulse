...
/**
 * Servlet implementation class UpdateAtm
 */
@WebServlet("/UpdateAtm")
public class UpdateAtm extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String strupdate="update hotel set name=?, location=? where sno=?";
		...
		try
		{
			...
			if(rw>0)
			{
				response.sendRedirect("jsp/viewAtm.jsp");
			}
		}
