...
String strsql="select * from hotel where sno=?";
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="article">
<form action="/SmartCity/UpdateHotels" method="post">   
	<table style="margin-left:25%;">
			...
			<td><a href="/SmartCity/jsp/viewHotels.jsp"><input type="button" name="cancel" value="CANCEL"/></a></td></tr>
		</table>
		</form>
