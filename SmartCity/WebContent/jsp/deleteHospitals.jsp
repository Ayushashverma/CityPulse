...
{%>
<form action="DeleteHospitals" method="post">
<table border=3>
...
String quer="select * from hospitals";
	...
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="jsp/updateHospitals.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
