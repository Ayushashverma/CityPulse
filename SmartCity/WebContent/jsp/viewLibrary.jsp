...
<div class="main">
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<h1 style="color: white">VIEW LIBRARY</h1>
					<div class="article">
<form action="/SmartCity/DeleteLibrary" method="post">
<table border=3>
...
String quer="select * from library";
	...
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="updateLibrary.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
