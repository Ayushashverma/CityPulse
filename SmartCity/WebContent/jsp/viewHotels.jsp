...
<div class="main">
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<h1 style="color: white">View Hotels</h1>
					<div class="article">
<form action="/SmartCity/DeleteHotels" method="post">
<table border=3>
...
String quer="select * from hotel";
	...
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="/SmartCity/jsp/updateHotels.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
