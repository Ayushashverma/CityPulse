...
<div class="main">
		...
		<div class="content">
			<div class="content_resize">
				...
				<div class="article">
						<h2>
							<span>ATM</span> DETAILS
						</h2>
						<div class="clr"></div>

						<form>
<table border=3>
<tr><th>BRANCH NAME</th><th>LOCATION</th></tr>
<%
Connection con=null;
...
String quer="select * from atm";
	...
	<tr><td><%=e %></td><td><a href="https://www.google.co.in/maps/search/<%=e %>+atm+location+in+<%=f %>+lucknow/@26.8400337,80.8885167,12z/data=!3m1!4b1" target="_blank"><span><%=f %></span></a></td></tr>
	<%}
}
