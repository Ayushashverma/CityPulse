	...
	<div class="main">
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<h1 style="color: white">Add Travel Agency</h1>
					<div class="article">
						<form action="/SmartCity/AddTravelAgency" method="post"
							onsubmit="return chkmain()">
							<table style="margin-left: 25%;">
								<tr>
									<td>NAME:</td>
									<td colspan=2><input type="text" name="txtname"
										id="txtname" placeholder="Enter NAME" /></td>
								</tr>
								<tr>
									<td>LOCATION:</td>
									<td colspan=2><input type="text" name="txtlocation"
										id="txtlocation" placeholder="Enter LOCATION" /></td>
								</tr>

								<tr>
									<td>WEBSITE</td>
									<td colspan=2><input type="text" name="txtmail"
										id="txtmail" placeholder="Enter WEBSITE" /></td>
								</tr>
								<tr style="text-align: center;">
									<td></td>
									<td colspan=2><input type="submit" name="register"
										value="ADD" /> <input type="reset" name="reset" value="RESET" /></td>
								</tr>
							</table>
						</form>
					</div>
