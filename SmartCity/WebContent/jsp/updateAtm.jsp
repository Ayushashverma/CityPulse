<%@ page language="java" contentType="text/html; charset=ISO-8859-1" import="java.sql.*,smartcity.db.*"
...
String strsql="select * from atm where sno=?";
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="article">
<form action="/SmartCity/UpdateAtm" method="post" onsubmit="return chkmain()">   
	<table style="margin-left:25%;">
			<tr>
				<td>BANK NAME:</td><td colspan=2><input type="text" name="txtname" id="txtname" value="<%=rs.getString("name")%>"/></td>
			</tr>
			<tr>
			<td>LOCATION:</td><td colspan=2><input type="text" name="txtlocation" id="txtlocation" value="<%=rs.getString("location")%>"/></td></tr>
			
			<tr style="text-align:center;"><td><input type="submit" name="register" value="UPDATE"/></td>
			<td><a href="viewAtm.jsp"><input type="button" name="cancel" value="CANCEL"/></a></td></tr>
		</table>
		</form>
