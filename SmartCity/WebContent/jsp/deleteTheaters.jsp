...
{%>
<form action="DeleteTheaters" method="post">
<table border=3>
...
String quer="select * from theaters";
	...
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="jsp/updateTheaters.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
