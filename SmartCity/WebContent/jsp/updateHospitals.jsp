...
String strsql="select * from hospitals where sno=?";
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="article">
<form action="/SmartCity/UpdateHospitals" method="post" onsubmit="return chkmain()">   
	<table style="margin-left:25%;">
			...
			<td><a href="viewHospitals.jsp"><input type="button" name="cancel" value="CANCEL"/></a></td></tr>
		</table>
		</form>
