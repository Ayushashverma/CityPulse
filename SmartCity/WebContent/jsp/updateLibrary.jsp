...
String strsql="select * from library where sno=?";
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="article">
<form action="/SmartCity/UpdateLibrary" method="post" onsubmit="return chkmain()">   
	<table style="margin-left:25%;">
			...
			<td><a href="viewLibrary.jsp"><input type="button" name="cancel" value="CANCEL"/></a></td></tr>
		</table>
		</form>
