...
<div class="main">
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<h1 style="color: white">VIEW JOBS</h1>
					<div class="article">
<form action="/SmartCity/DeleteJobs" method="post">
<table border=3>
<tr><th>SELECT</th><th>NAME</th><th>DOMAIN</th><th>WEBSITE</th><th>UPDATE</th></tr>
<%
Connection con=null;
...
String quer="select * from jobs";
	...
	String f=rs.getString("domain");
	String g=rs.getString("website");
	%>
	
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="/SmartCity/jsp/updateJobs.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
