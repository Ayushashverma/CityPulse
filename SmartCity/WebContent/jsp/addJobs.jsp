	...
	<div class="main">
		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					<h1 style="color: white">Add Jobs</h1>
					<div class="article">
						<form action="/SmartCity/AddJobs" method="post"
							...
							<table style="margin-left: 25%;">
								...
								<tr>
									<td>DOMAIN:</td>
									<td colspan=2><input type="text" name="txtdomain"
										id="txtdomain" placeholder="Enter DOMAIN" /></td>
								</tr>
