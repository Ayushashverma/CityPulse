...
<table border=3>
<tr><th>SELECT</th><th>NAME</th><th>DOMAIN</th><th>WEBSITE</th>UPDATE</tr>
<%
Connection con=null;
...
String quer="select * from jobs";
	...
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="jsp/updateJobs.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
