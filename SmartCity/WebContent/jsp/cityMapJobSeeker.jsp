...
<script>function initMap() {
        var uluru = {lat: 26.8467, lng: 80.9462};
...
<script async defer
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrrMb5aPZ1kWDfQ22szg-VTPP8_xDUV58&callback=initMap">
    </script>
		...
		<div class="fbg_resize">
			<div class="col c1">
				...
				<a href="#"><img src="../images/gal1.jpg" width="75" height="75"
					alt="" class="gal" /></a> <a href="#"><img
					src="../images/gal2.jpg" width="75" height="75" alt="" class="gal" /></a>
				<a href="#"><img src="../images/gal3.jpg" width="75" height="75"
					alt="" class="gal" /></a> <a href="#"><img
					src="../images/gal4.jpg" width="75" height="75" alt="" class="gal" /></a>
				<a href="#"><img src="../images/gal5.jpg" width="75" height="75"
					alt="" class="gal" /></a> <a href="#"><img
