<%@ page language="java" import="java.sql.*,smartcity.db.*"
			...
			<div class="header_resize">
				...
				<div class="menu_nav">
					<ul>
						...
						<li><a href="../touristlogin.jsp"><span>Tourist Guide</span></a></li>
