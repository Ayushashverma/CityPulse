		...
		<div class="content">
			<div class="content_resize">
				<div class="mainbar">
					...
					<div class="article">
<form action="/SmartCity/DeleteIndustries" method="post">
<table border=3>
...
String quer="select * from industries";
	...
	<tr><td><input type="checkbox" name="chk" value=<%=d %>></td><td><%=e %></td><td><%=f %></td><td><%=g %></td><td><a href="/SmartCity/jsp/updateIndustries.jsp?msid=<%=rs.getString("sno") %>">EDIT</a></td></tr>
	<%}
}
